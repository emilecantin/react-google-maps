...
function getInstanceFromComponent(component) {
  return component.context[_withGoogleMap.MAP];
}
...
exports.default = (0, _flowRight3.default)(_react2.default.createClass, (0, _enhanceElement2.default)(getInstanceFromComponent, publicMethodMap, eventMap, controlledPropUpdaterMap))({
  ...
  getInitialState: function getInitialState() {
    this.context[_withGoogleMap.MAP].setOptions((0, _enhanceElement.collectUncontrolledAndControlledProps)(defaultUncontrolledPropTypes, controlledPropTypes, this.props));
    return null;
  },
