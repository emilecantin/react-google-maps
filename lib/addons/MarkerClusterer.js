...
exports.MARKER_CLUSTERER = undefined;
...
var publicMethodMap = {
  ...
  addMarker: function addMarker(markerClusterer, marker) {
    var nodraw = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
...
exports.default = (0, _flowRight3.default)(_react2.default.createClass, (0, _enhanceElement2.default)(getInstanceFromComponent, publicMethodMap, eventMap, controlledPropUpdaterMap))({
  ...
  getInitialState: function getInitialState() {
    // http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclustererplus/docs/reference.html#events
    var markerClusterer = new _markerClustererPlus2.default(this.context[_withGoogleMap.MAP], [], (0, _enhanceElement.collectUncontrolledAndControlledProps)(defaultUncontrolledPropTypes, controlledPropTypes, this.props));
    return (0, _defineProperty3.default)({}, MARKER_CLUSTERER, markerClusterer);
  },
  componentDidUpdate: function componentDidUpdate() {
    var markerClusterer = this.state[MARKER_CLUSTERER];
