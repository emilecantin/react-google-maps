...
function collectProps(propTypes /*: Object*/, props /*: Object*/) {
  var keyTransform = arguments.length <= 2 || arguments[2] === undefined ? _identity3.default : arguments[2];
    ...
    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
      ...
      (0, _forEach3.default)(controlledPropUpdaterMap, function (fn, key) {
        ...
        if (nextValue !== prevProps[key]) {
          fn(getInstanceFromComponent(_this), nextValue);
        }
      });
...
var enhanceWithEventMap = (0, _curry3.default)(function (getInstanceFromComponent, eventMap, componentSpec) {
  var _componentSpec$compon2 = componentSpec.componentDidUpdate;

  var _componentDidUpdate2 = _componentSpec$compon2 === undefined ? _noop3.default : _componentSpec$compon2;

  var _componentSpec$compon3 = componentSpec.componentWillUnmount;

  var _componentWillUnmount = _componentSpec$compon3 === undefined ? _noop3.default : _componentSpec$compon3;
