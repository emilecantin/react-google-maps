...
function withGoogleMap(WrappedComponent) {
  ...
  return _temp2 = _class = function (_Component) {
    ...
    function Container() {
      var _Object$getPrototypeO, _context;
      ...
      return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(Container)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
        map: null
      }, _this.handleComponentMount = (_context = _this).handleComponentMount.bind(_context), _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }

    (0, _createClass3.default)(Container, [{
      key: "getChildContext",
      value: function getChildContext() {
        return (0, _defineProperty3.default)({}, MAP, this.state.map);
      }
    }, {
  ...
  }, _class.childContextTypes = (0, _defineProperty3.default)({}, MAP, _react.PropTypes.object), _temp2;
}